...
ylab('AUC') + ggtitle('Area under ROC Curve Across Varying \nMixing Parameter') +
  theme_bw()
...
```{r, cache=TRUE, echo = FALSE, include=TRUE, message = FALSE, warning= FALSE, out.width = '80%', fig.align='center'}
