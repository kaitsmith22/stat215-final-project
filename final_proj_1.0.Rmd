...
knitr::kable(df, "pipe", digits=3, caption = 'Single Decision Tree with 10 Variables')
```
...
#kable_styling(bootstrap_options = "striped", full_width = F, latex_options = "HOLD_position")
knitr::kable(df, "pipe", digits=3, caption = 'Gradient-Boosted Tree                  ')
```
...
knitr::kable(df, "simple", digits=3, caption = 'Logistic Regression') |> kable_styling(full_width = T)
```
