...
```{r, echo = FALSE, include=TRUE, message = FALSE, warning= FALSE, out.width = '100%', fig.align='center'}
...
#kable(round(df,2), "pipe", caption = 'Decision Rule from Leonard et al. (2011)')
```
