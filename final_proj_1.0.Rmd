...
```{r, fig.caption = "Plot of order features are added to the Lasso model, as the L1 Norm increases. For a large L1 Norm, the lasso solution is equivalent to the OLS solution.", fig.height=3.5}
...
df_freq <- df_freq |> arrange(desc(Frequency))
...
knitr::kable(df, "pipe", digits=3, caption = 'Logistic Regression')
```
